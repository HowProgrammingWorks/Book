...
slow('Ich bin ein langsamer Logger');
warning('Hallo');
error('Welt');
debug('Auf Wiedersehen!');
```

> Objektmethodenverkettung
...
```js
// Normale Rückgabe des Ergebnisses
const sum = (a, b) => a + b;

// Rückgabe des Ergebnisses an eine Callback-Funktion
...
> Timer-Implementierung mit Callback
...
const cities = ['Kiew', 'London', 'Peking'];
